...
const modules = [
  {
    ...
    icon: ClipboardList,
    label: 'Templates',
                description: 'Crie tarefas vinculadas a um grupo',
    color: 'text-blue-400',
    bg: 'bg-blue-500/10',
  },
  {
    ...
    icon: Layers,
    label: 'Grupos',
    description: 'Monte pacotes para atribuir de uma vez aos funcionários',
  ...
  },
  {
    ...
    icon: CalendarClock,
    label: 'Atribuições',
    description: 'Atribua grupos de tarefas aos funcionários',
