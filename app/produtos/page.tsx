...
import { Plus, Search, Package, Edit2, Trash2, Upload, Filter, TrendingUp, Layers } from "lucide-react";
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-400">Gerencie seus produtos de forma centralizada</p>
            </div>
...
export default function ProdutosPage() {
  return (
    <ToolProtection tool={SystemTool.PRODUTOS} toolName="Produtos">
      <ProdutosPageContent />
    </ToolProtection>
  );
}
